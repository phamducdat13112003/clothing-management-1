            ...
            <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
              <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                ...
                <tr>
                  ...
                  <th class="sherah-table__column-2 sherah-table__h8" style="text-align: center;">Action</th>
                </tr>
                </thead>
                  ...
                  <tr>
                    ...
                    <td class="sherah-table__column-4 sherah-table__data-7" style="text-align: center;">
                      <div class="sherah-table__status__group" style="display: inline-flex; gap: 10px;">
                        <a href="editsupplier?supplierId=${supplier.supplierId}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                        ...
                        <a href="javascript:void(0);" onclick="confirmDelete('${supplier.supplierId}')" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
              ...
              <div class="pagination">
                ...
                <c:forEach var="i" begin="1" end="${totalPages}">
                  <a href="managesupplier?page=${i}&search=${search}" class="${i == currentPage ? 'active' : ''}">${i}</a>
                </c:forEach>
