...
<div class="sherah-body-area">
    ...
    <div class="container mt-4">
        <div class="form-container">
            <h3 class="mb-3 text-center">Update Purchaseorder</h3>
            <c:if test="${not empty errorMessage1}">
                <div class="alert" style="color: red; letter-spacing: normal">${errorMessage1}</div>
                <% session.removeAttribute("errorMessage1"); %> <!-- Xóa sau khi hiển thị -->
            </c:if>
            <form action="updatepurchaseorder" method="get">
                <input type="text" name="poid" value="${poid}" hidden="hidden">
                    ...
                    <div class="left-section">
                        <div class="box mb-3">
                            ...
                            <div class="product-list">
                                <c:forEach var="podetail" items="${podetailList}">
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function () {
                                            let product = {
                                                poDetailId: "${podetail.PODetailID}",
                                                productId: "${podetail.ProductDetailID}",
                                                productName: "${podetail.ProductName}",
                                                productImage: "${podetail.ProductImage}",
                                                productColor: "${podetail.Color}",
                                                productSize: "${podetail.Size}",
                                                productPrice: "${podetail.Price}",
                                                productSupplier: "${podetail.ProductSupplierID}",
                                                productQuantity: "${podetail.Quantity}" // Thêm số lượng
                                            };
                    ...
                    <div class="right-section">
                        <div class="box mb-3">
                            ...
                            <select class="form-control" id="supplierId" name="supplierid"
                                ...
                                <option value="${supplier.supplierId}">Select Supplier</option>
                                <c:forEach items="${suppliers}" var="suppliers">
                                    <option value="${suppliers.supplierId}"
                                            data-name="${suppliers.supplierName}"
                            ...
                            <table class="table table-bordered mt-3">
                                <tr>
                                    <th>Email</th>
                                    <td id="supEmail">${supplier.supplierId}</td>
                                </tr>
                                <tr>
                                    <th>Phone</th>
                                    <td id="supPhone">${supplier.phone}</td>
                                </tr>
                                <tr>
                                    <th>Address</th>
                                    <td id="supAddress">${supplier.address}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="box">
...
<script>
    ...
    function renderSelectedProducts() {
        ...
        selectedProducts.forEach(product => {
            let productHtml = `
                                ...
                                placeholder="1" value="` + product.productQuantity + `" min="1" style="width: 80px;">
    ...
    function updateTotal() {
        ...
        productContainers.forEach(container => {
            ...
            totalPriceInput.value = total; // Cập nhật tổng tiền từng sản phẩm
            totalAmount += total;
        });
