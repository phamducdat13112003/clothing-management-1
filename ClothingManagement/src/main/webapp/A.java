                ...
                <div class="sherah-body">
                    ...
                    <div class="sherah-dsinner">
                        ...
                        <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                            <form class="sherah-wc__form-main" action="editemployee" method="post"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group__input">
                                                            <input class="sherah-wc__form-input"
                                                                   placeholder="Employee Id" type="hidden"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group__input">
                                                            <input class="sherah-wc__form-input"
                                                                   placeholder="Employee Name" type="text" name="name"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="sherah-wc__form-label">Employee Image <span
                                                                class="required">*</span></label>
                                                        <div class="form-group__input">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label class="sherah-wc__form-label">Date of birth <span
                                                                class="required">*</span></label>
                                                        <div class="form-group__input">
                                                            <input value="${employee.dob}" class="sherah-wc__form-input"
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="product-form-box sherah-border mg-top-30">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="sherah-wc__form-label">Status <span
                                                                class="required">*</span></label>
                                                        <div class="form-group__input">
                                            ...
                                            <div class="mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary">Save
                                                </button>
                                                <button type="button" class="sherah-btn sherah-btn__third">Cancel
                                                </button>
                                            </div>
                                        </div>
                                    </div>
