              ...
              <div class="row align-items-center justify-content-between">
                <div class="col-6">
                  <div class="sherah-breadcrumb mg-top-30">
                    <h2 class="sherah-breadcrumb__title">View Bin Inventory Detail</h2>
                      ...
                      <tr>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.id}</p>
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <img src=".${pd.image}" alt="Product Image" width="100" height="100">
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.color}</p>
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.size}</p>
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.weight}</p>
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.quantity}</p>
                          </div>
                        </td>
                        <td class="sherah-table__column-2 sherah-table__data-2">
                          <div class="sherah-table__product-content">
                            <p class="sherah-table__product-desc">${pd.status}</p>
                          </div>
                        </td>
                      </tr>
                    </c:forEach>
