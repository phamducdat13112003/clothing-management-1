						...
						<div class="col-lg-6 col-12">
							...
							<div class="charts-main sherah-default-bg charts-home-two sherah-border mg-top-30">
								...
								<div class="charts-main__one">
									<div class="tab-content" id="nav-tabContent">
										<div class="tab-pane fade show active" id="sherah-chart__t3" role="tabpanel" aria-labelledby="sherah-chart__t1">
											<div class="sherah-chart__inside sherah-chart__monthly--states">
												<!-- Chart One -->
												<canvas id="myChart_one_monthly"></canvas>
											</div>
										</div>
										<div class="tab-pane fade" id="sherah-chart__t4" role="tabpanel" aria-labelledby="sherah-chart__t1">
											<div class="sherah-chart__inside sherah-chart__monthly--states">
												<!-- Chart One -->
												<canvas id="myChart_one_monthly"></canvas>
											</div>
									...
									<div class="charts-main sherah-default-bg charts-home-two sherah-border mg-top-30">
										...
										<div class="charts-main__one">
											<div class="tab-content" id="nav-tabContent">
												...
												<div class="tab-pane fade" id="sherah-chart__t2" role="tabpanel" aria-labelledby="sherah-chart__t1">
													<div class="sherah-chart__inside sherah-chart__monthly--states">
														<!-- Chart One -->
														<canvas id="myChart_one_monthly"></canvas>
													</div>
