                    ...
                    <div class="sherah-dsinner">
                        ...
                        <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                            <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                ...
                                <tr>
                                    <th class="sherah-table__column-2 sherah-table__h2">EmployeeID</th>
                                    <th class="sherah-table__column-2 sherah-table__h2">employeeName</th>
                                    ...
                                    <th class="sherah-table__column-4 sherah-table__h8" style="text-align: center;">
                                        Action
                                    </th>
                                </tr>
                                </thead>
                                    ...
                                    <tr>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">${employee.employeeID}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__vendor">
                                                <h4 class="sherah-table__vendor--title"><a style="color: blue"
                                                                                           href="employeedetail?employeeId=${employee.employeeID}">${employee.employeeName}</a>
                                                </h4>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">${employee.email}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc">${employee.address}</p>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__product-content">
                                        ...
                                        <td class="sherah-table__column-4 sherah-table__data-7"
                                            ...
                                            <div class="sherah-table__status__group"
                                                ...
                                                <a href="editemployee?employeeId=${employee.employeeID}"
                            ...
                            <div class="pagination">
                                ...
                                <c:forEach var="i" begin="1" end="${totalPages}">
                                    <a href="manageemployee?page=${i}&search=${search}"
