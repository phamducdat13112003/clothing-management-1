          ...
          <div class="sherah-body">
            ...
            <div class="sherah-dsinner">
              ...
              <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                ...
                <c:if test="${not empty transferdosuccessfully}">
                  <div class="alert" style="color: green">${transferdosuccessfully}</div>
                  <% session.removeAttribute("transferdosuccessfully"); %> <!-- Xóa sau khi hiển thị -->
                </c:if>
                <div class="search-container">
                  <form action="searchdeliveryorder" method="GET" class="search-form">
