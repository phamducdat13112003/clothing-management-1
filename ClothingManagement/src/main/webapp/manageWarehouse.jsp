          ...
          <div class="sherah-dsinner">
            <div class="row">
              <div class="col-12">
                <div class="sherah-breadcrumb mg-top-30">
                  <h2 class="sherah-breadcrumb__title">Manage Warehouse</h2>
                  <ul class="sherah-breadcrumb__list">
                    <li><a href="#">Home</a></li>
                    <li class="active"> <a href="#" id="addAccountBtn" >Manage Warehouse</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
              <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                ...
                <tr>
                  <th class="sherah-table__column-2 sherah-table__h2">WarehouseID</th>
                  <th class="sherah-table__column-3 sherah-table__h3">WarehouseName</th>
                  <th class="sherah-table__column-4 sherah-table__h4">Address</th>
                  ...
                  <tr>
                    <td class="sherah-table__column-2 sherah-table__data-2">
                      <div class="sherah-table__product-content">
                        <p class="sherah-table__product-desc">${warehouse.warehouseId}</p>
                      </div>
                    </td>
                    <td class="sherah-table__column-2 sherah-table__data-2">
                      <div class="sherah-table__product-content">
                        <p class="sherah-table__product-desc">${warehouse.warehouseName}</p>
                      </div>
                    </td>
                    <td class="sherah-table__column-2 sherah-table__data-2">
                      <div class="sherah-table__product-content">
                        <p class="sherah-table__product-desc">${warehouse.address}</p>
                      </div>
                    </td>
                    <td class="sherah-table__column-4 sherah-table__data-7" style="text-align: center;">
                      <div class="sherah-table__status__group" style="display: inline-flex; gap: 10px;">
                        <a href="warehouseForm?action=update&warehouseId=${warehouse.warehouseId}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                        ...
                        <a href="warehouse?action=delete&warehouseId=${warehouse.warehouseId}" class="sherah-table__action sherah-color2 sherah-color2__bg--offset" onclick="return confirm('Are you sure you want to delete this warehouse?');">
                        ...
                        <a href="warehouseForm?action=create">Add</a>
                      </div>
                    </td>
                  </tr>
                </c:forEach>
